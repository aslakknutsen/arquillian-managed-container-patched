 ...
 * @since 17-Nov-2010
 */
public final class PatchedManagedDeployableContainer extends CommonDeployableContainer<PatchedManagedContainerConfiguration> {
    ...
    private final Logger log = Logger.getLogger(PatchedManagedDeployableContainer.class.getName());
    private Thread shutdownThread;
    private Process process;

    public Class<PatchedManagedContainerConfiguration> getConfigurationClass() {
        return PatchedManagedContainerConfiguration.class;
    }
    ...
    protected void startInternal() throws LifecycleException {
        PatchedManagedContainerConfiguration config = getContainerConfiguration();
